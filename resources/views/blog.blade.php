            ...
            <div class="col-lg-6">
                <nav class="header__menu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="{{route('blog-page')}}">Blog</a></li>
            ...
            <div class="col-lg-10">
                <div class="blog__details__content">
                    <div class="blog__details__title">
                        ...
                        <img src="/staging-assets/img/blog/details/blog-details.jpg" alt="">
                    ...
                    <div class="blog__details__pic">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <img src="/staging-assets/img/blog/details/bi-1.jpg" alt="">
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <img src="/staging-assets/img/blog/details/bi-2.jpg" alt="">
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <img src="/staging-assets/img/blog/details/bi-3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="blog__details__author">
                        <div class="blog__details__author__pic">
                            <img src="/staging-assets/img/blog/blog-about.png" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <a href="#" class="blog__details__btns__item">
                                    <div class="blog__details__btns__item__pic">
                                        <img src="/staging-assets/img/blog/details/prev.jpg" alt="">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <a href="#" class="blog__details__btns__item blog__details__btns__item--next">
                                    <div class="blog__details__btns__item__pic">
                                        <img src="/staging-assets/img/blog/details/next.jpg" alt="">
                                    </div>
                                    <div class="blog__details__btns__item__text">
